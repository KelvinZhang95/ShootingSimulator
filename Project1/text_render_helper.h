...
public:
	TextRenderHelper()
		:shader("shader/text.vs", "shader/text.fs")
	{}

	TextRenderHelper(int w, int h)
		:shader("shader/text.vs", "shader/text.fs")
	{
	...
	void Render(float mask, string str,int x, int y)
	{
		...
		RenderText(shader, str, x, y, 1.0f, glm::vec3(1.0, 0.8f, 0.2f));
